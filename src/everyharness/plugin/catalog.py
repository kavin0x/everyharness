...
CATALOG: tuple[CatalogEntry, ...] = (
    ...
    CatalogEntry(
        ...
        pypi_name="everyharness",
        kind="harness",
        summary="Thin LLM wrapper over Ollama/GGUF/HF with OpenAI-compatible /v1 serve.",
    ...
    CatalogEntry(
        ...
        pypi_name="everyharness",
        kind="harness",
        summary="Image classification (ONNX Runtime or HF pipelines); no object detect in v1.",
    ...
    CatalogEntry(
        ...
        pypi_name="everyharness",
        kind="harness",
        summary="Whisper transcription only; TTS and HTTP serve not in v1.",
    ...
    CatalogEntry(
        ...
        pypi_name="everyharness",
        kind="harness",
        summary="Text-to-image generate via Diffusers (CLI only; no serve in v1).",
    ...
    CatalogEntry(
        ...
        pypi_name="everyharness",
        kind="harness",
        summary="Experimental: dry-run JSON planner; --allow-control only supports echo.",
        tags=("builtin", "computer", "agent", "experimental"),
    ),
    CatalogEntry(
        name="local",
        pypi_name="everyharness",
    ...
    CatalogEntry(
        ...
        kind="harness",
        summary="Docs-only example plugin (not a production community package).",
        tags=("example", "docs"),
    ),
)
